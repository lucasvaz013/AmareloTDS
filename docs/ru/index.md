...
- [Установка на shared hosting](shared-hosting.md)
- [Установка через панели управления](hosting-panels.md)
...
2. Для чистого VPS выполните [Установку на VPS](installation.md), для обычного виртуального хостинга — [Установку на shared hosting](shared-hosting.md), а для собственного сервера с панелью — [Установку через панели управления](hosting-panels.md).
