# AmareloTDS Documentation

This is the main product, admin, and runtime documentation for AmareloTDS.
...
- [Landings](landings.md)
- [Networks and Destinations](networks-and-destinations.md)
- [Meta Conversions API](meta-capi.md)
- [Integrations](integrations.md)
- [Domains Automation](domains-automation.md)

## Automation and API

- [API and Endpoints](api-and-endpoints.md)
- [Admin API](admin-api.md)
- [ytds CLI](ytds-cli.md)
- [Operating with the ytds CLI](operating-with-ytds.md)
